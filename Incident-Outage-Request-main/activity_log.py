"""Append-only audit trail of state-changing actions (logins, sync runs,
user management changes). Copied from outage_tracker-main/utils/activity_log.py
to match its exact shape -- never logs read-only page views, that's a
deliberate scope decision carried over, not an oversight.
"""
